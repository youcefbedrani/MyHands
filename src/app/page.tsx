          ...
          <div className="flex w-full max-w-[521px] flex-col gap-7">
            ...
            <div className="flex gap-4">
              <Link
                ...
                rel="noopener noreferrer"
                title="View projects"
                className="rounded-lg bg-indigo-500 px-6 py-3 font-semibold leading-6 text-white duration-150 ease-in hover:bg-indigo-400 shadow-md"
              >
                View Case Studies
              </Link>
              <Link
                ...
                rel="noopener noreferrer"
                title="Contact me"
                className="rounded-lg border-2 border-indigo-500 px-6 py-3 font-semibold leading-6 text-indigo-500 duration-150 ease-in hover:bg-indigo-50 shadow-sm"
              >
                Start Your Project
              </Link>
            </div>
