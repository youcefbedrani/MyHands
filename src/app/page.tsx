      ...
      >
        ...
        <div className="z-10 flex flex-col items-center gap-6 pt-14">
          ...
          <p className="max-w-[850px] text-center font-montserrat text-2xl text-neutral-800">
            “Nullam vitae vestibulum ex, quis ornare lectus. Morbi dictum sem
            sed orci semper, ut lobortis nisl feugiat. Donec pharetra orci id
            velit efficitur viverra non sed dui.”
          </p>
